...
{{$localeConfig.brandName}} 提供 [Android SDK](/reference-new/mobile/sdk-for-android.md) 和 [iOS SDK](/reference-new/sdk-for-swift.md) 帮助开发者在移动 APP 中快速集成 {{$localeConfig.brandName}}。
...
详细的安装指引请见：[{{$localeConfig.brandName}} Java/Kotlin SDK](/reference-new/web/sdk-for-java/README.md) 。
...
详细文档请见：[用户注册登录 API](/reference-new/web/sdk-for-java/authentication/README.md) 。
