...
const translatedZhCnNavBar = {
  ...
  "/workflow/": [
    {
      title: "An overview of identity automation",
      path: "/workflow/overview/",
    },
    {
      title: "Quick start",
      ...
      children: [
        {
          ...
          path: "/workflow/write-workflow/create-workflow",
        },
        {
          title: "Add trigger",
          path: "/workflow/write-workflow/add-trigger",
        },
        {
          title: "Add node",
        ...
        {
          title: "Dynamically assemble data for nodes",
          path: "/workflow/write-workflow/dynamically-assemble-data-for-nodes",
        },
        {
          title: "Debugging Workflow",
          path: "/workflow/write-workflow/debugging-workflow",
        },
        {
          title: "Copy Workflow",
          path: "/workflow/write-workflow/copy-workflow",
        },
        {
          title: "Import and Export Workflow",
          path: "/workflow/write-workflow/import-and-export-workflow",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          path: "/workflow/execute-workflow/manual-execution",
        },
        {
          title: "Activate Workflow",
          path: "/workflow/execute-workflow/activate-workflow",
        },
        {
          title: "Trigger Workflow through application events",
          path: "/workflow/execute-workflow/events",
        },
        {
          title: "Trigger Workflow through timed execution",
          path: "/workflow/execute-workflow/timed",
        },
        {
          title: "Trigger Workflow through Webhook",
          path: "/workflow/execute-workflow/trigger-workflow-through-webhook",
        },
        {
          title: "Trigger Workflow via HTTP request",
          path: "/workflow/execute-workflow/trigger-workflow-via-http-request",
        },
        {
          title: "Viewing Workflow Execution Records",
          path: "/workflow/execute-workflow/viewing-workflow-execution-records",
        },
      ],
    },
    {
    ...
    //   children: [
    //     {
    //       title: "Event Center Overview",
    //       path: "/workflow/Event Center/",
    //     },
    //   ],
    // },
    {
