...
::: page-ref /reference-new/api-services/sdk-for-java/authentication/AuthenticationClient.md
:::
...
::: page-ref /reference-new/api-services/sdk-for-java/authentication/StandardProtocol.md
:::
