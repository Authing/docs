...
::: page-ref /reference-new/api-services/sdk-for-python/authentication/AuthenticationClient.md
:::
...
::: page-ref /reference-new/api-services/sdk-for-python/authentication/StandardProtocol.md
:::

如果你需要使用 MFA，请使用：

::: page-ref /reference-new/api-services/sdk-for-python/authentication/MfaAuthenticationClient.md
:::
