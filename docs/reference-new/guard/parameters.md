...
| qrCodeScanOptions     | 扫码登录配置，详情请查看 [QrCodeAuthenticationClient().startScanning(domId, options)](/reference-new/Standard-web-application/sdk-for-node/authentication/QrCodeAuthenticationClient.html#一键开始扫码) 的 options 参数 | Objcect                                   | 否             | null                                               |                                            |
| lang                  | **使用语言**                                                                                                                                                                                                         | [Lang](#lang)                             | 否             | Lang.zhCn                                          |                                            |
| localesConfig         | **语言环境配置**                                                                                                                                                                                                     | [LocalesConfig](#localesconfig)           | 否             | -                                                  |                                            |
| host                  | 私有部署时的 API 请求地址                                                                                                                                                                                            | String                                    | 私有部署时必传 | [{{$localeConfig.brandName}} 官方 api 地址]        |                                            |
