...
class ManagementClientTest {
    ...
    public static void main(String[] args) {
        ...
        request.setBirthdate("2022-07-06");
        ...
        SendEmailOrPhoneNotification= new SendEmailOrPhoneNotificationDto(
                    request.setSendEmailNotification("test@example.com");
    request.setSendPhoneNotification("176xxxx6754");
