...
class ManagementClientTest {
    ...
    public static void main(String[] args) {
        ...
        ListPermissionRoleDto request = new ListPermissionRoleDto();
        request.setPage(1);
        request.setLimit(10);
        request.setQuery("示例应用");
        request.setAppIds(new List<String>("60b49eb83fd80adb96f26e68","60b49eb83fd80adb96f26e68",));
        
        RoleListPageRespDto response = managementClient.permissionListRoles(request);
