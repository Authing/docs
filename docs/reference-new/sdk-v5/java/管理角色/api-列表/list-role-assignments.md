...
class ManagementClientTest {
    ...
    public static void main(String[] args) {
        ...
        ListRoleAssignmentsDto request = new ListRoleAssignmentsDto();
        request.setPage(1);
        request.setLimit(10);
        request.setQuery("示例应用");
        request.setAppId("60b49eb83fd80adb96f26e68");
        request.setRoleCode("code_1");
        request.setTargetType(new List<String>("USER","ORG",));
        
        RoleListPageRespDto response = managementClient.listRoleAssignments(request);
