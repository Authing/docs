...
class ManagementClientTest {
    ...
    public static void main(String[] args) {
        ...
        UpdatePermissionRoleDto request = new UpdatePermissionRoleDto();
        request.setRoleCode("code_1");
        request.setAppId("6076bacxxxxxxxxd80d993b");
        request.setRoleName("测试用户");
        request.setDescription("这个一个角色的描述信息");
        
        RolePermissionUpdateRespDto response = managementClient.permissionUpdateRole(request);
