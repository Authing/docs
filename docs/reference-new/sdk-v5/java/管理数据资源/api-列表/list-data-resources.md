...
class ManagementClientTest {
    ...
    public static void main(String[] args) {
        ...
        request.setPage(1); 
        request.setLimit(10); 
        request.setQuery("示例1"); 
        request.setAppIds("["6301ceaad4677b9255f27478","6301ceaad4677b9255f27478"]");
        ListDataResourcesPaginatedRespDto response = managementClient.listDataResources(request);
