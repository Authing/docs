...
class ManagementClientTest {
    ...
    public static void main(String[] args) {
        ...
        request.setResourceName("数据资源");
        request.setResourceCode("123");
        request.setAppId("60b49eb83fd80adb96f26e68");
        request.setDescription("这个是一个示例数据资源");
        request.setType("TREE");
            Struct= new List<DataResourceStructs>(
                    new DataResourceStructs().set

               request.setCode("123");
      request.setValue("这个是一个示例数据资源");
      request.setName("数据资源");
      request.setChildren(new List<String>("[object Object]",));
      
                  ),
        
        CreateDataResourceResponseDto response = managementClient.createDataResource(request);
