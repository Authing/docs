...
class ManagementClientTest {
    ...
    public static void main(String[] args) {
        ...
        UpdateEmailVerifyRequestDto request = new UpdateEmailVerifyRequestDto();
        request.setVerifyMethod(UpdateEmailVerifyRequestDto.verifyMethod.EMAIL_PASSCODE);
    ...
    request.setOldEmailPassCode("123456");
        ...
        VerifyUpdateEmailRequestRespDto response = managementClient.veirfyUpdateEmailRequest(request);
