...
namespace Example
{
    class Program
    {
      ...
      private static async Task MainAsync()
      {
          ...
          RoleListPageRespDto  result = await managementClient.PermissionListRoles
          (  new ListPermissionRoleDto{                  Page= 1 ,
                  Limit= 10 ,
                  Query= "示例应用" ,
                  AppIds= new List<string>{"60b49eb83fd80adb96f26e68","60b49eb83fd80adb96f26e68",} ,
            }
          );
        }
    }
