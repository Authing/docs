...
namespace Example
{
    class Program
    {
      ...
      private static async Task MainAsync()
      {
          ...
          VerifyUpdateEmailRequestRespDto  result = await managementClient.VeirfyUpdateEmailRequest
          (  new UpdateEmailVerifyRequestDto{                  VerifyMethod= UpdateEmailVerifyRequestDto.verifyMethod.EMAIL_PASSCODE ,
