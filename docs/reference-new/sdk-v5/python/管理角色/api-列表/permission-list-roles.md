...
| appIds | array[] | 否 | - | 按照应用 id 列表进行筛选。   | `["60b49eb83fd80adb96f26e68","60b49eb83fd80adb96f26e68"]` |
...
data = management_client.permission_list_roles(
     page: 1,
     limit: 10,
     query: "示例应用",
     app_ids: ["60b49eb83fd80adb96f26e68","60b49eb83fd80adb96f26e68"],
