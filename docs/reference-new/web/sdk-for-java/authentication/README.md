...
::: page-ref /reference-new/web/sdk-for-java/authentication/AuthenticationClient.md
:::
...
::: page-ref /reference-new/web/sdk-for-java/authentication/StandardProtocol.md
:::
