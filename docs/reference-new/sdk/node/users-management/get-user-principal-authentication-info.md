...
| 名称 | 类型 | 必填 |默认值| 描述 |
| ---- |  ---- | ---- | --- | ---- |
| authenticated | boolean | \* |  | 是否进行认证。 示例值： `true`  |
  | principalType | string | \* |  | 用户 ID。 示例值： `认证主体类型，P 代表个人，E 代表企业`  |
  | principalCode | string | \* |  | 认证主体证件号码。 示例值： `6229c4deb3e4d8a20b6021ff`  |
  | principalName | string | \* |  | 认证主体名称。 示例值： `ss`  |
  | authenticatedAt | string | \* |  | 认证时间，标准时间字符串。 示例值： `2022-04-05T10:23:50.631Z`  |
