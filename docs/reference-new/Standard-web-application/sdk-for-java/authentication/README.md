...
::: page-ref /reference-new/standard-web-application/sdk-for-java/authentication/AuthenticationClient.md
:::
...
::: page-ref /reference-new/standard-web-application/sdk-for-java/authentication/StandardProtocol.md
:::
